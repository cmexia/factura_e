...
<body>
    %for o in objects :
        ...
        <table class="basic_table" style="color:#121212">
            <tr class="firstrow">
                <th align="center" width="5%">${_("Cant.")}</th>
                <th align="center" width="5%">${_("Unidad")}</th>
                <th align="center" width="40%">${_("Descripci&oacute;n")}</th>
                <th align="center" width="12%" >${_("P.Unitario")}</th>
                <th align="center" width="17%">${_("Importe")}</th>
            </tr>
            <%row_count = 1%>
	...
	%for dict in invoice_lines:
                    ...
                    <td align="left" class="number_custom">${ dict['cantidad']} </td>
                    <td align="left" class="number_custom">${ dict['unidad']}  </td>
                    <td align="left" class="description" width="40%">${ dict['descripcion']}  </td>
                    <td align="center" width="9%" class="number_td">${ dict['precio_unitario']}  </td>
                    <td align="center" width="15%" class="number_td">${ dict['importe']} </td>
                    </tr>
                    % if dict['pedimentos']:
                    <!--<tr>
                    ...
                    <!--<tr class="firstrow">
                        ...
                        %for pedimento in dict['pedimentos']:
                            <tr>
                                <td width="17%" align="center" class="number_td">Aduana ${ pedimento['aduana']} </td>
                                <td width="17%" align="center" class="number_td">Fecha Aduana ${ pedimento['fecha']} </td>
                                <td width="17%" align="center" class="number_td">Numero Pedimento ${ pedimento['numero']} </td>
                            </tr>
        ...
        <table class="basic_table">
            ...
            <tr>
            <td class="vigencia"><i>
                El plazo para devoluciones es de 15 días naturales a partir de la entrega. Es necesario presentar producto en empaque original.
Garantía: Equipo americano 1 año en partes y 5 años en compresor. Equipo asiático 1 año en partes y compresor. No aplica en equipo con fallas eléctricas ni quemaduras.</i>></td>
            </tr> <!--+-->                
        </table>
        <table class="basic_table">
            <tr>
